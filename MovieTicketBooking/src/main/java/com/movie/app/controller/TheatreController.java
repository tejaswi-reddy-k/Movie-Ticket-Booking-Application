...
public class TheatreController {
	...
	public ResponseEntity<List<Theatre>> getTheatreByLocationAndMovieName(@RequestParam("location") String location,@RequestParam String movieName)
	{
	...
	{
		Theatre response = service.addTheatre(theatre);
		return new ResponseEntity<Theatre>(response, HttpStatus.CREATED);
	}
}
